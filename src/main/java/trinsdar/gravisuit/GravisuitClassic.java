...
public class GravisuitClassic {
    ...
    public static final String DEPENDS ="required-after:ic2;required-after:ic2-classic-spmod;before:gtc_expansion@[0.2.1,);before:ic2c_extras@[1.4.8,);after:betterpipes@[0.14,)";
