...
public class GravisuitRecipes {
    ...
    public static void initShapedRecipes(){
        ...
        recipes.addRecipe(new ItemStack(Registry.magnetron), "ICI", "CSC", "ICI", 'I', "ingotRefinedIron", 'C', "ingotCopper", 'S', Registry.superConductor);
        ...
        recipes.addRecipe(new ItemStack(Registry.vajra), "INI", "DVC", "ALA", 'I', Ic2Items.iridiumPlate, 'N', Ic2Items.nanoSaber, 'D', Registry.advancedDiamondDrill, 'V', Registry.vajraCore, 'C', Registry.advancedChainsaw, 'A', Ic2Items.advancedAlloy, 'L', Ic2Items.lapotronCrystal);
    }
