...
public class GravisuitConfig {
    ...
    public static class PowerValues {
        ...
        public int ADVANCED_ELECTRIC_JETPACK_TRANSFER, ADVANCED_LAPPACK_TRANSFER, ULTIMATE_LAPPACK_TRANSFER, GRAVITATION_JETPACK_TRANSFER, GRAVITOOL_TRANSFER, VAJRA_TRANSFER, RELOCATOR_TRANSFER;
    }
    ...
    public static class CommonConfig {
        public final ForgeConfigSpec.IntValue ADVANCED_ELECTRIC_JETPACK_STORAGE, ADVANCED_NUCLEAR_JETPACK_STORAGE, ADVANCED_LAPPACK_STORAGE, ULTIMATE_LAPPACK_STORAGE, GRAVITATION_JETPACK_STORAGE,
                NUCLEAR_GRAVITATION_JETPACK_STORAGE, GRAVITOOL_STORAGE, VAJRA_STORAGE, RELOCATOR_STORAGE;
        public final ForgeConfigSpec.IntValue ADVANCED_ELECTRIC_JETPACK_TRANSFER, ADVANCED_LAPPACK_TRANSFER, ULTIMATE_LAPPACK_TRANSFER, GRAVITATION_JETPACK_TRANSFER,
                GRAVITOOL_TRANSFER, VAJRA_TRANSFER, RELOCATOR_TRANSFER;
